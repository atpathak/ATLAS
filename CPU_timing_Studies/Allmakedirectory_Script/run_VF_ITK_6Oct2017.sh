...
if [ ${THIS_N} = "-1" -o ${THIS_N} = "${n}" ] ; then
 ...
 echo $rtag $n $skipevt
 rm -rf    VF_ITK_6Oct2017_r${rtag}/RunArea/Reconstr_${n}
 mkdir -vp VF_ITK_6Oct2017_r${rtag}/RunArea/Reconstr_${n}
 cd        VF_ITK_6Oct2017_r${rtag}/RunArea/Reconstr_${n}
 if [ $rtag = "9871" ] ; then
   cat > reco.todo <<EOF
Reco_tf.py \\
--inputRDOFile ${input} \\
...
#sleep ${sleep}
#cd /data/apathak/VF_ITK_6Oct2017_r${rtag}
#source workarea.sh
...
cd /data/apathak/VF_ITK_6Oct2017_r${rtag}/RunArea/Reconstr_${n}
