...
if [ ${THIS_N} = "-1" -o ${THIS_N} = "${n}" ] ; then
 ...
 echo $rtag $n $skipevt
 rm -rf    VF_ITK_30Oct2017_r${rtag}/RunArea_${m}/Reconstr_${n}
 mkdir -vp VF_ITK_30Oct2017_r${rtag}/RunArea_${m}/Reconstr_${n}
 cd        VF_ITK_30Oct2017_r${rtag}/RunArea_${m}/Reconstr_${n}
 if [ $rtag = "9871" ] ; then
   cat > reco.todo <<EOF
Reco_tf.py \\
--inputRDOFile ${input} \\
...
cd /data/apathak/VF_ITK_30Oct2017_r${rtag}/RunArea_${m}/Reconstr_${n}
