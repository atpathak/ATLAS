...
if [ ${THIS_N} = "-1" -o ${THIS_N} = "${n}" ] ; then
 ...
 sleep=`echo $n | awk '{print 30*($1-1)}'`
 echo $rtag $n $skipevt
 rm -rf    VF_ITK_9Oct2017_r${rtag}/RunArea_100/Reconstr_${n}
 mkdir -vp VF_ITK_9Oct2017_r${rtag}/RunArea_100/Reconstr_${n}
 cd        VF_ITK_9Oct2017_r${rtag}/RunArea_100/Reconstr_${n}
 if [ $rtag = "9871" ] ; then
   cat > reco.todo <<EOF
Reco_tf.py \\
--inputRDOFile ${input} \\
...
cd /data/apathak/VF_ITK_9Oct2017_r${rtag}/RunArea_100/Reconstr_${n}
rm -f reco.log
