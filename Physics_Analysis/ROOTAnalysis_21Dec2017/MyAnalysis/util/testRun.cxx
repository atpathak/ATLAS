...
int main( int argc, char* argv[] ) {
  ...
  // std::string inputFilePath = PathResolverFindCalibDirectory("/eos/user/a/atpathak/LFV_Input/mc15_13TeV.345121.PowhegPy8EG_NNLOPS_nnlo_30_ggH125_tautaulm15hp20.merge.DAOD_HIGG4D2.e5814_s2726_r7772_r7676_p3228/");
  //SH::ScanDir().filePattern("DAOD_HIGG4D2.11788927*").scan(sh,inputFilePath);
  //std::string inputFilePath = PathResolverFindCalibDirectory("/eos/user/a/atpathak/LFV_Input/mc15_13TeV.345122.PowhegPy8EG_NNLOPS_nnlo_30_ggH125_tautaulp15hm20.merge.DAOD_HIGG4D2.e5814_s2726_r7772_r7676_p3228/");
  //SH::ScanDir().filePattern("DAOD_HIGG4D2.11788560*").scan(sh,inputFilePath);
  //std::string inputFilePath = PathResolverFindCalibDirectory("/eos/user/a/atpathak/LFV_Input/mc15_13TeV.345074.PowhegPy8EG_NNPDF30_AZNLOCTEQ6L1_VBFH125_tautaulm15hp20.merge.DAOD_HIGG4D2.e5822_s2726_r7772_r7676_p3228/");
  //SH::ScanDir().filePattern("DAOD_HIGG4D2.11788528*").scan(sh,inputFilePath);
  std::string inputFilePath = PathResolverFindCalibDirectory("/eos/user/a/atpathak/LFV_Input/mc15_13TeV.345075.PowhegPy8EG_NNPDF30_AZNLOCTEQ6L1_VBFH125_tautaulp15hm20.merge.DAOD_HIGG4D2.e5822_s2726_r7772_r7676_p3228/");
  SH::ScanDir().filePattern("DAOD_HIGG4D2.11789095*").scan(sh,inputFilePath);
