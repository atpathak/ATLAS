...
TQAnalysisJob::TQAnalysisJob(TString name_) : TNamed(name_.Data(), "") {
...
void TQAnalysisJob::setTreeObservableTemplates(TList * treeObservableTemplates){
  WARNclass("this functionality is deprecated. please use 'TQObservable::addObservable(myObservable,name)' instead");
  TQObservableIterator itr(treeObservableTemplates);
  while(itr.hasNext()){
