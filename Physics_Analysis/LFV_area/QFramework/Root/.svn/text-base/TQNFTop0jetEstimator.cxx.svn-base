...
bool TQNFTop0jetEstimator::initializeSelf(){
  ...
  if(!(cnt_mc_cr && cnt_mc_numerator && cnt_mc_denominator && cnt_data_cr && cnt_data_numerator && cnt_data_denominator)){
    ...
    if(cnt_mc_numerator) delete cnt_mc_numerator;
    ...
    if(cnt_mc_denominator) delete cnt_mc_denominator;
    ...
    if(cnt_data_cr) delete cnt_data_cr;
    ...
    if(cnt_data_numerator) delete cnt_data_numerator;
    ...
    if(cnt_data_denominator) delete cnt_data_denominator;
