...
// TQStringUtils:
//
// The TQStringUtils class provides a set of static utility methods related to the inspection
// and manipulation of strings (there is no point in creating an instance of this class).
//
// String comparison and matching:
//
// - isEmpty(...) checks if string is empty (optionally ignoring blanks)
// 
// - matches(...) performs string pattern matching with wildcards
// 
// - compare(...) ---
// 
// - compareHeads(...) determines length of longest common leading subsequence of
// two strings
// 
// - compareTails(...) determines length of longest common trailing subsequence of
// two strings
// 
// - getMaxCommonHead(...) ---
// 
...
// String manipulation:
//
// - removeEscapes(...) removing escape characters from a string
// 
// - insertEscapes(...) inserting escape characters into a string
// 
// - append(...) concatenation of strings with automatic separator
// 
// - removeLeading(...) remove certain characters from head of string
// 
// - removeLeadingText(...) remove string sequence from head of string
// 
// - removeTrailing(...) remove certain characters from tail of string
// 
// - removeTrailingText(...) remove string sequence from tail of string
// 
//
// String templates:
//
// - repeat(...) repeat a string sequence n times with optional separator
// 
// - repeatSpaces(...) repeat spaces n times
// 
// - repeatTabs(...) repeat tabs n times
// 
// 
// Other stuff
// 
// - getUniqueName(...) determines a new object name unique in a given instance of
// TDirectory
//
//
////////////////////////////////////////////////////////////////////////////////////////////////
...
TString TQStringUtils::getDetails(TObject * obj) {
  ...
  } else if (obj->InheritsFrom(TQCounterGrid::Class())) {
    TQCounterGrid* g = dynamic_cast<TQCounterGrid*>(obj);
    g->resetProjectionRanges();
    return g->getDetailsAsString();
...
TString TQStringUtils::concat(const std::vector<TString>& items, const TString& sep) {
  // concatenate a vector of TString to a single string using the given separator
  bool first = true;
  TString text;
