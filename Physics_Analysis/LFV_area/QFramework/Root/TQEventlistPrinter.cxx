...
// TQEventlistPrinter:
//
// The TQEventlistPrinter class uses an TQSampleDataReader to obtain cutflow numbers to print cutflow
// tables in ordinary text style or in latex style. 
//
////////////////////////////////////////////////////////////////////////////////////////////////
...
TQPresenter()
{
  // Default constructor of TQEventlistPrinter class:
}
...
TQEventlistPrinter::TQEventlistPrinter(TQSampleFolder * samples) : 
  TQPresenter(samples)
{
  // Constructor of TQEventlistPrinter class:
}
