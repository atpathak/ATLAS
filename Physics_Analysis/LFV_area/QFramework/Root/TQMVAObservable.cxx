...
inline size_t TQMVAObservable::Reader::size() const {
  return this->fValues.size();
}
inline const TString& TQMVAObservable::Reader::getExpression(size_t i) const {
  return this->fExpressions[i];
}
inline double TQMVAObservable::Reader::getValue() const {
...
inline void TQMVAObservable::Reader::fillValue(size_t i,double val) const {
  this->fValues[i]=val;
}
