...
// TQListUtils:
//
// The TQListUtils class provides a set of static utility methods related to lists
//
// List stuff:
//
// - print(...) print contents of a list
// 
// - removeElements(...) remove elements in a list according to a string filter
//
// - reorder(...) reorder elements in one list according to another list
// 
// - isSubsetOf(...) test if one list is subset of another list
// 
// - areIsomorphic(...) test if two lists are isomorphic (1:1 association of elements)
// 
// - hasDuplicates(...) test if a list has two elements with the same name
// 
// - sortByStringLength(...) ---
// 
//
...
bool TQListUtils::sortByStringLength(TList * list, bool ascending) {
