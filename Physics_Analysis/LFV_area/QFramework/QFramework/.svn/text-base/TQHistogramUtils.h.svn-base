...
namespace TQHistogramUtils {
  ...
  void interpolateGraph(TGraph* g, size_t increasePoints);
  ...
  TH1 * getRebinned(TH1 * histo, const std::vector<int>& binBorders, bool doRemap);
  TH1 * getRebinned(TH1 * histo, const std::vector<double>& lowEdges, bool doRemap);
  TH1 * getRebinned(TH1 * histo, const std::vector<int>& binBorders, const std::vector<double>& lowEdges, bool doRemap);
  ...
  bool getMinMaxBin(TH1 * histo, int &minBin, int &maxBin, bool includeError = false, bool includeUnderflowOverflow = true);
  bool getMinMax(TH1 * histo, double &min, double &max, bool includeError = false, bool includeUnderflowOverflow = true);
  int getMinBin(TH1 * histo, bool includeError = false, bool includeUnderflowOverflow = true);
  int getMaxBin(TH1 * histo, bool includeError = false, bool includeUnderflowOverflow = true);
  double getMin(TH1 * histo, bool includeError = false, bool includeUnderflowOverflow = true);
  double getMax(TH1 * histo, bool includeError = false, bool includeUnderflowOverflow = true);
  double getMax(TCollection* c, bool includeUnderflowOverflow = true);
  double getMin(TCollection* c, bool includeUnderflowOverflow = true);
  ...
  template<class TMatrixTT> TH2* convertMatrixToHistogram(TMatrixTT* matrix, const TString& name);
