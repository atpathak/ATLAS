...
protected:
  ...
  int sumElements( TList * list, TQCounterGrid * &countergrid, TQTaggable * options );
  ...
  TList * getBaseScaleFactors(TQSampleFolder * sampleFolder, TString path, TString scaleScheme, int indent);
...
public:
  ...
  virtual TQCounterGrid*getCounterGrid (const TString& path, const TString& name, const TString& options = "", TList * sfList = 0);
  virtual TQCounterGrid*getCounterGrid (const TString& path, const TString& name, TQTaggable* options, TList * sfList = 0);
  ...
  virtual TList * getListOfCounterGridNames(const TString& path = ".", TList * sfList = 0);
