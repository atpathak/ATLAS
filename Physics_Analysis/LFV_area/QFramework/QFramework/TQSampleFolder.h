...
protected:
  ...
  bool mergeAsSampleFolder(TQSampleFolder* f, const TString& traceID, bool sumElements, bool verbose);
...
public:
  ...
  int visitMe(TQSampleVisitor * visitor);
  ...
  ClassDefOverride(TQSampleFolder, 2);
