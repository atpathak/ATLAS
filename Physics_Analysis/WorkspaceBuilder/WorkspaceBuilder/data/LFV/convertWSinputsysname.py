...
def convertWS(filepath):
    ...
    outfile = TFile(dirname+"/name_"+filename, "recreate")
    ...
    channel_list = ["mtau_cba_sr1_vbf_signal","mtau_cba_sr2_vbf_signal","mtau_cba_sr3_vbf_signal","mtau_cba_vbf_signal","etau_cba_sr1_vbf_signal","etau_cba_sr2_vbf_signal","etau_cba_sr3_vbf_signal","etau_cba_vbf_signal"]
    ...
    for channel in channel_list:
        ...
        for i in range(0,n_sample):
            ...
            file = open("sys_list_lephad_name", "r")
            for variation in file:
                ...
                for insample in input_sample_list[i]:
                    ...
                    if variation == "theory_sig_shower_high":
                        #print(variation)
                        histo = infile.Get(channel+"/"+insample+"/theory_sig_shower")
                    #elif variation == "theory_ztt_MGvsSh_high":
                     #   histo = infile.Get(channel+"/"+insample+"/theory_ztt_MGvsSh")
                    else:
