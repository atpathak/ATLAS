...
nf  = "WorkspaceBuilder/data/Fake/Fake_normfactors13TeV.txt"
of  = "WorkspaceBuilder/data/Fake/Fake_overallsystematics13TeV.txt"
xml = "WorkspaceBuilder/data/Fake/Fake_AllCombination.xml"
outputpath = "workspacesFake"

def makeSubmitStr( x ):

    #the next argument defines the "StatAnalysis" as comes in Fake_AllCombination.xml
    outstr  = "BuildWorkspace -s TauFake"
