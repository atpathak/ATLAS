...
int x0_plots_3(string fileNameIn = "InclBrl4", string phi = "", string slice = "all"){
  ...
  while( (key = (TKey*)next()) ){
	...
	*/
    ...
    cout << "-9. Plot name = " << key->GetName() << " = " << name << endl;
    if(fileNameIn.find("ID") != string::npos){
      //      cout << "fileNameIn has ID" << endl;
      //if(name.find("Chip") != string::npos) name = "PixelChips";
      cout << "-8.9 Plot name = " << key->GetName() << " = " << name << endl;
      if(name.find("Cooling") != string::npos) name = "Cooling";
      cout << "-8.8 Plot name = " << key->GetName() << " = " << name << endl;
      if(name.find("Cool") != string::npos) name = "Cooling";
      cout << "-8.7 Plot name = " << key->GetName() << " = " << name << endl;
      if(name.find("CO2") != string::npos) name = "Cooling";
      cout << "-8.6 Plot name = " << key->GetName() << " = " << name << endl;
      if(name.find("Cryo") != string::npos) name = "Cooling";
      cout << "-8.5 Plot name = " << key->GetName() << " = " << name << endl;
      //      if(name.find("Pipe") != string::npos) name = "Cooling";
      cout << "-8.2 Plot name = " << key->GetName() << " = " << name << endl;
      ...
      cout << "-8.1 Plot name = " << key->GetName() << " = " << name << endl;
      ...
      if(name.find("Pigtail") != string::npos) name = "Cooling";
      cout << "-8. Plot name = " << key->GetName() << " = " << name << endl;
      if(name.find("Aerogel") != string::npos) name = "Aerogel";
      cout << "-7. Plot name = " << key->GetName() << " = " << name << endl;
      if(name.find("AerogelRun2") != string::npos) name = "Aerogel";
      cout << "-6. Plot name = " << key->GetName() << " = " << name << endl;
     ...
     cout << "-5. Plot name = " << key->GetName() << " = " << name << endl;
    }else{ 
     cout << "-5a. Plot name = " << key->GetName() << " = " << name << endl;
      //      cout << "fileNameIn does not have ID" << endl;    
      if(name.find("CO2") != string::npos) name = "Cooling";
    ...
    cout << "-4. Plot name = " << key->GetName() << " = " << name << endl;
    ...
    if(name.find("Inconel_H1") != string::npos) name = "BeamPipe";
    cout << "-3. Plot name = " << key->GetName() << " = " << name << endl;
    if(name.find("Aerogel") != string::npos) name = "BeamPipe";
    cout << "-2.5 Plot name = " << key->GetName() << " = " << name << endl;
    if(name.find("AerogelRun2") != string::npos) name = "BeamPipe";
    cout << "-2. Plot name = " << key->GetName() << " = " << name << endl;
    ...
    cout << "-1. Plot name = " << key->GetName() << " = " << name << endl;
    if(fileNameIn.find("ID") != string::npos){
